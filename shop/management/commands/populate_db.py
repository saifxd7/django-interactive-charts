...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--amount', type=int, help='The number of purchase that should be created.')

    def handle(self, *args, **options):
        names = ['James', 'Saif', 'Jayesh', 'Michael', 'William', 'Nizam', 'Rahul', 'Vijay', 'Thomas', 'Amani']
        surname = ['Smith', 'Shaikh', 'Vaghela', 'Brown', 'Williams', 'Shaikh', 'Vishwakarma', 'Kamble', 'Patel', 'Qureshi']
        ...
        for i in range(0, amount):
            ...
            dt = pytz.timezone('Asia/Calcutta').localize(datetime.now() - timedelta(days=random.randint(0, 1825)))
